...
Abre el archivo `starter/index.html` y completa cada sección siguiendo las instrucciones en los comentarios. Cuando termines, compara tu resultado con `completed/index.html`.
